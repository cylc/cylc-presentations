...
const cylcUsingSiteData = [
      ...
      { name: 'NIWA-2',
        ...
        devSite: true,
        forceLabelCoors: false,
        latLonDecimalDegrees: [-41.2865, 174.7762],
        umPartnerSite: true},
      { name: 'NIWA-3',
        shortName: 'NIWA-3',
        devSite: false,
        forceLabelCoors: false,
        latLonDecimalDegrees: [-43.5321, 172.6362],
        umPartnerSite: true},
...
var map = new ol.Map({
  ...
  view: new ol.View({
    center: ol.proj.fromLonLat([-41.28, 174.77].reverse()),
    zoom: 10,
    minZoom: 1.7 // prevent zoom out to extent labels overwhelm & spoil view
  }),
});
